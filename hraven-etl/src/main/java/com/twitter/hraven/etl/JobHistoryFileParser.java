...
/**
 * Interface for job history file parsing Should be implemented for parsing different formats of
 * history files change by MAPREDUCE-1016 in hadoop1.0 as well as hadoop2.0
 */
...
public interface JobHistoryFileParser {
  ...
  /**
   * Return the generated list of job puts assembled when history file is parsed
   * @return a list of jobPuts
   */
  public List<Put> getJobPuts();

  /**
   * Return the generated list of task puts assembled when history file is parsed
