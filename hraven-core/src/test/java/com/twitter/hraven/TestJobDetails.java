...
public class TestJobDetails {
  ...
  public void testGetValueAsLong() {
    ...
    assertEquals(expVal, jd.getValueAsLong(JobHistoryKeys.TOTAL_MAPS, infoValues));
  ...
  public void testGetValueAsString() {
    ...
    infoValues.put(JobHistoryKeys.KEYS_TO_BYTES.get(JobHistoryKeys.JOBNAME),
      Bytes.toBytes(JobDetailsValues.jobName));
    assertEquals(JobDetailsValues.jobName, jd.getValueAsString(JobHistoryKeys.JOBNAME, infoValues));
    // test non existent values
    assertEquals("", jd.getValueAsString(JobHistoryKeys.JOB_QUEUE, infoValues));
  }
