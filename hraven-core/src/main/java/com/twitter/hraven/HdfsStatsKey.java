...
/**
 * Represents the row key for a given job.
...
public class HdfsStatsKey {
   ...
   *          the hdfs path
   * @param encodedRunId
   *          Inverted top of the hour timestamp at which stats were collected
   */
  @JsonCreator
  ...
  public String toString() {
    ...
    return this.pathKey.toString() + HdfsConstants.SEP + this.encodedRunId;
  }
}